...
| 5  	| close  	| J12 needs a 180deg rotation         | |
| 6  	| close  	| DDR3 RAM VSSQ_5 connected to 1.35V  | |
| 7  	| open  	| Add LEDs to all DC DC Outputs       | |
| 8  	| open  	| Add shut restistors at the in/output of each DC DC | |
| 9  	| close  	| 1V DC DC EN voltage too low         | Modify the value of resistor divider R36 and R37|
...
| 15	| close   | MCU LEDs are very bright  	        | increase pre-diode resistors to 1k |
...
| 18 	| close   | Rotate one JTAG pin header so the have the same orientation | |
