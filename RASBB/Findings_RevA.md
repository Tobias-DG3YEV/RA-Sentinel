...
| 21	| open    | Add JTAG header target to silkscreen Text | like "STM32", "FPGA 1", "FPGA 2"|
| 22	| open    | Correct second flash signals to FPGA2 | SO and SI connection should be swapped |
