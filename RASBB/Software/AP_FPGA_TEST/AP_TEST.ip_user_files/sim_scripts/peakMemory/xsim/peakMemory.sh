...
#
# Script generated by Vivado on Sun Jun 02 10:43:41 +0200 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : peakMemory.sh
...
#
# Usage        : peakMemory.sh
#                peakMemory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                peakMemory.sh [-reset_run]
#                peakMemory.sh [-reset_log]
#                peakMemory.sh [-help]
#
...
# script info
echo -e "peakMemory.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./peakMemory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot peakMemory xil_defaultlib.peakMemory xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim peakMemory -key {Behavioral:sim_1:Functional:peakMemory} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb peakMemory.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./peakMemory.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: peakMemory.sh [-help]\n\
Usage: peakMemory.sh [-step]\n\
Usage: peakMemory.sh [-lib_map_path]\n\
Usage: peakMemory.sh [-reset_run]\n\
Usage: peakMemory.sh [-reset_log]\n\
Usage: peakMemory.sh [-keep_index]\n\
Usage: peakMemory.sh [-noclean_files]\n\n\
