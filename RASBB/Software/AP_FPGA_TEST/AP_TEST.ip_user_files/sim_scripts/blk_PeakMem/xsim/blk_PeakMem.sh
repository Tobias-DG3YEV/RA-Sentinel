...
#
# Script generated by Vivado on Mon Jun 03 14:51:38 +0200 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : blk_PeakMem.sh
...
#
# Usage        : blk_PeakMem.sh
#                blk_PeakMem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_PeakMem.sh [-reset_run]
#                blk_PeakMem.sh [-reset_log]
#                blk_PeakMem.sh [-help]
#
...
# script info
echo -e "blk_PeakMem.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_PeakMem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_PeakMem xil_defaultlib.blk_PeakMem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_PeakMem -key {Behavioral:sim_1:Functional:blk_PeakMem} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blk_PeakMem.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blk_PeakMem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blk_PeakMem.sh [-help]\n\
Usage: blk_PeakMem.sh [-step]\n\
Usage: blk_PeakMem.sh [-lib_map_path]\n\
Usage: blk_PeakMem.sh [-reset_run]\n\
Usage: blk_PeakMem.sh [-reset_log]\n\
Usage: blk_PeakMem.sh [-keep_index]\n\
Usage: blk_PeakMem.sh [-noclean_files]\n\n\
