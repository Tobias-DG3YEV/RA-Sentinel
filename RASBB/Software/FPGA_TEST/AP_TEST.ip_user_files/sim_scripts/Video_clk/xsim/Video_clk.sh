...
#
# Script generated by Vivado on Sun Apr 20 19:46:53 +0200 2025
...
#
# Usage        : Video_clk.sh
#                Video_clk.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Video_clk.sh [-reset_run]
#                Video_clk.sh [-reset_log]
#                Video_clk.sh [-help]
#
...
# script info
echo -e "Video_clk.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Video_clk.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Video_clk xil_defaultlib.Video_clk xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Video_clk.wdb xsim.dir libdpi.so)
...
Usage: Video_clk.sh [-step]\n\
Usage: Video_clk.sh [-lib_map_path]\n\
Usage: Video_clk.sh [-reset_run]\n\
Usage: Video_clk.sh [-reset_log]\n\
Usage: Video_clk.sh [-keep_index]\n\
