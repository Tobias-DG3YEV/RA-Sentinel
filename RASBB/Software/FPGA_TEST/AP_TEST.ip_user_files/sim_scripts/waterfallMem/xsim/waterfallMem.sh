...
#
# Script generated by Vivado on Sun Jun 02 11:26:21 +0200 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : waterfallMem.sh
...
#
# Usage        : waterfallMem.sh
#                waterfallMem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                waterfallMem.sh [-reset_run]
#                waterfallMem.sh [-reset_log]
#                waterfallMem.sh [-help]
#
...
# script info
echo -e "waterfallMem.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./waterfallMem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot waterfallMem xil_defaultlib.waterfallMem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim waterfallMem -key {Behavioral:sim_1:Functional:waterfallMem} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb waterfallMem.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./waterfallMem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: waterfallMem.sh [-help]\n\
Usage: waterfallMem.sh [-step]\n\
Usage: waterfallMem.sh [-lib_map_path]\n\
Usage: waterfallMem.sh [-reset_run]\n\
Usage: waterfallMem.sh [-reset_log]\n\
Usage: waterfallMem.sh [-keep_index]\n\
Usage: waterfallMem.sh [-noclean_files]\n\n\
