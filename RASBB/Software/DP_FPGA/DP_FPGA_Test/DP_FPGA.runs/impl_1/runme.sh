...
HD_PWD='D:/Data/RASentinel/RASBB/DP-FPGA/DP_FPGA/DP_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DP_FPGA_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DP_FPGA_top.tcl -notrace
