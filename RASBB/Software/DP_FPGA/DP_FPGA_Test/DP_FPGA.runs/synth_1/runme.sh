...
HD_PWD='D:/Data/RASentinel/RASBB/DP-FPGA/DP_FPGA/DP_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DP_FPGA_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DP_FPGA_top.tcl
