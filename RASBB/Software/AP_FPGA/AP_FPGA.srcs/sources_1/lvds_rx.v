...
(
    ...
    input wire i_masterClk,   // master clock for strobe generation 
    ...
    output reg [11:0] o_dataOut_R,  // parallel data, real part
    output reg [11:0] o_dataOut_I,   // parallel data, imaginary part
    ...
    generate
        for (j = 0; j < 4; j = j + 1) begin : gen_idelaye2_iserdese2
            ...
            ISERDESE2 #(
                ...
                .CLK( o_lvds_dclk ),     // 1-bit input: High-speed clock input
                .CLKB( ~o_lvds_dclk ),   // 1-bit input: Inverted high-speed clock input
...
//	assign o_dataOut_I = { q1[3], q2[3], q3[3], q4[3], q5[3], q6[3], q1[2], q2[2], q3[2], q4[2], q5[2], q6[2] };
    ...
    //sample ready strobe generator 
    always @(negedge i_masterClk) // >= 100MHz driven
    begin
        if(ctr == 0 && o_sampleStrobe == 0)
            o_sampleStrobe <= 1;
        else
            o_sampleStrobe <= 0;
    end
    ...
    begin
        ...
        // sync everything with frame start
            ...
            if(o_lvds_fclk == 1 && trig == 0) begin
                ...
                ctr <= 0;
                fclk_delayed <= 0;
        	    o_dataOut_R <= { q1[1], q2[1], q3[1], q4[1], q5[1], q6[1], q1[0], q2[0], q3[0], q4[0], q5[0], q6[0] };
	            o_dataOut_I <= { q1[3], q2[3], q3[3], q4[3], q5[3], q6[3], q1[2], q2[2], q3[2], q4[2], q5[2], q6[2] };
            end
            else begin
                ctr <= ctr + 1;
                trig <= 0;
