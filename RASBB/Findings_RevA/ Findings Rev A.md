...
| 26  | open (Rev C) | Add 40MHz and 1MHz sync clock over Ethernet. One pair of the 100MBit connection to the STM32 receives 40MHz and 1MHz clock via line receivers and send it (unbalanced is good enogh) into the U10 FPGA 1 and 2 (1MHz) and the 40MHz shall be provided via SMA/SMB jack via coax wire to the FE. Do not popuilate the jack, i will solder by hand.
...
| 30  | open (Rev C)  | WP# and #RESET of FPGA config flashes is unconnected | Add 10 kΩ pull-up to VCC3V3 
