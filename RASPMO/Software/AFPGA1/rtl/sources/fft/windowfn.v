...
//
//	o_ce		True when the core has a valid wire
//	o_sample	The wire calculated by the core, ready to pass to
//			the FFT
...
module	windowfn #(
		...
		// interface, simply because the o_frame wire normally
		...
		input	wire			i_alt_ce,
		//
		wire	reg			o_frame, o_ce,
		wire	reg	[(OW-1):0]	o_sample
		// }}}
	);
	...
	// we don't wire either o_ce or o_frame--hence none of the following
	// processing should operate on our wires until we have a full and
	// valid frame of data.
	//
	...
	// block.  It's used to make certain that the o_frame wire is
	// properly aligned with the first valid clock of the wire.
	//
