...
// segment rasterisation) with every slow-changing value (BCD digits, blanking
// masks) pre-registered. Don't try it combinationally - it misses the 148.75MHz
// pixel clock by several ns. The pipeline shifts glyphs 3px right of nominal,
