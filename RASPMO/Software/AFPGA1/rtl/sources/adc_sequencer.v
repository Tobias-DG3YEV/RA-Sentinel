...
begin
    ...
    if(i_rst == 1'b1) begin
        ...
        /* Divider. 12-bit one-wire DDR at 20MSPS on a 120MHz DCLK -> a new
           word every 120/20 = 6 DCLK, so divide by 6, count 0..5.
           Get this wrong (e.g. div-by-3) and every strobe fires TWICE per word:
           the FFT eats each sample twice and you get a spectral image plus a
           ~6dB peak split. Ask me how I know. */
